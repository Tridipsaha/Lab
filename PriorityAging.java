...
class Process2 {
    int id,arrivalTime,burstTime, priority, tempPriority, startTime, completionTime, waitingTime, turnaroundTime;
    boolean completed ;
...
public class PriorityAging {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            processes.add(new Process2((i+1), arrivalTime, burstTime, priority));
        }
        ...
        System.out.println("Throughput: "+n/AverageTurnAroundTime);
